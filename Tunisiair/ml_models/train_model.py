...
Original file is located at
    https://colab.research.google.com/drive/1xFQ99fPdHp_rk6TgACEtrZ6bJa1b0cvQ
"""
...
# load data
train= pd.read_csv('train_FD001.txt', sep=" ", header=None, names = column_names_)
...
explore = sns.PairGrid(data=train_with_target.query('UnitNumber < 2') ,
                 x_vars=target_var,
...
dump(optimized_gb, "predictive_maintenance_1.joblib")
...
uploaded = drive.CreateFile({'title': 'predictive_maintenance.joblib'})
uploaded.SetContentFile('predictive_maintenance.joblib')
uploaded.Upload()
